...
const BuyCard = (props) => {
    ...
    return (
        <div className='m-0 p-0 box-border'>
            <div className='bg-[#f5f6f8] border h-[468px] w-[300px] drop-shadow-lg rounded-3xl flex flex-col gap-1 cursor-pointer'>
                ...
                {/* Date and Price*/}
                <div className='flex h-[1%] w-[90%] m-auto text-[#410066d6] justify-between mt-5' >
